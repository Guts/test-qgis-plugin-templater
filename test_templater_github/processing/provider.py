...
# project
from test_templater_github.__about__ import __icon_path__, __title__, __version__
...
class TestTemplaterGithubProvider(QgsProcessingProvider):
    """

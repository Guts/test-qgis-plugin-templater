...
- during a QGIS session only once: set it in the command line when launching QGIS, for example: `QGIS_QGIS_PLUGIN_TEMPLATER_TEST_GITHUB_DEBUG_MODE=true qgis` or `env QGIS_QGIS_PLUGIN_TEMPLATER_TEST_GITHUB_DEBUG_MODE=true qgis` depending on your system.
...
| :---------------- | :------------------------------------------: | :--------------------------: |
| Enable debug mode | `QGIS_QGIS_PLUGIN_TEMPLATER_TEST_GITHUB_DEBUG_MODE` | `False` |

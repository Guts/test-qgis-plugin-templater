# test_templater_github - QGIS Plugin
...
| :-- | :--: |
| Plugin name | test_templater_github |
| Plugin name slugified | test_templater_github |
| Plugin name class (used in code) | TestTemplaterGithub |
...
| Git repository URL | https://gitlab.com/Oslandia/test_templater_github/ |
...
- homepage: <https://gitlab.com/Oslandia/test_templater_github/>
- repository: <https://gitlab.com/Oslandia/test_templater_github/>
- tracker: <https://gitlab.com/Oslandia/test_templater_github//issues>
...
1. Have a look to the [plugin's metadata.txt file](test_templater_github/metadata.txt): review it, complete it or fix it if needed (URLs, etc.).
